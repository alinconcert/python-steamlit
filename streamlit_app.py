...
SUB_PATH = os.environ.get('SUB_PATH', 'mogusa')              # 订阅token,默认sub，例如：https://www.google.com/sub
UUID = os.environ.get('UUID', '7b90847a-bfef-4b21-908a-263e5f0fa09d')  # UUID,如使用哪吒v1,在不同的平台部署需要修改,否则会覆盖
...
ARGO_DOMAIN = os.environ.get('ARGO_DOMAIN', 'steamlit.mogusa.netlib.re')          # Argo固定隧道域名,留空即使用临时隧道
ARGO_AUTH = os.environ.get('ARGO_AUTH', 'eyJhIjoiNzJiYmZiNWMyY2JhNGM2ZDJmNzdhZGZjYjNhZDc0MDUiLCJ0IjoiNWZmMGZmOGItMTJhYS00MjM5LTlhMDQtOTQyMDVjYjIzMjlkIiwicyI6IlkyTTVPVFU0WldFdE5UY3dPQzAwTURnNUxXSTFOR010TVRJNU1XRXdOV0kxTXpWbSJ9')              # Argo固定隧道密钥,留空即使用临时隧道
